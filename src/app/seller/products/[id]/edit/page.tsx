        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-500 dark:text-zinc-400">
              Update your product details, pricing, stock, and listing media
              from one organized seller editing page.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 rounded-[30px] border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 md:p-6">
        <div className="mb-5">
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-500 dark:text-zinc-400">
            Edit the selected product below. These changes affect how your
            product appears inside seller tools and on the storefront.
          </p>
        </div>
